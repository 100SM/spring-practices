package com.poscoict.logex2.controller;
...
public class ExampleController2 {
	...
	public String ex2() {
		 ...
		 * 
		 * 1. fileAppender2 와 "com.poscoict.logexample2" logger 를 살펴 보아야 합니다.
		 * 
		 ...
		 * 확인해 봐야 합니다.
		 * 
		 * 4. 새로운 로거를 세팅하고 있습니다. "com.douzone.logex2" 로거인데, 파일로만 로그를 남기고 있는 것을 확인해야 합니다.
		 * 
